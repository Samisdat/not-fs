...
//var unrealFsDefaults = require('../../defaults');
...
FsTree.prototype.climbDepthFirst = function(callback) {
...
FsTree.prototype.exists = function(path){
    ...
    this.climbDepthFirst(function(child){
...
FsTree.prototype.log = function(){
    ...
    var climb = function(harvest){
        ...
        if (undefined !== harvest.getChildren){
