...
Tree.prototype.getInodeNumberByPath = function(pathName){
    ...
    var climb = function(inodeNumber){
        console.log(pathName, tree.getPathByInodeNumber(inodeNumber));
...
Tree.prototype.addFile = function(filePath, data, addMissingDirs){
    ...
    console.log(parentInodeNumber, name);
    var file = new File(
        this.getInodeNumber(),
        name,
        parentInodeNumber,
    ...
    console.log('getName', file.getName());
    console.log('getInodeNumber', file.getInodeNumber());
