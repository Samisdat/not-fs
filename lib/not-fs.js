...
notFs.Stats.prototype._checkModeProperty = function(property) {
  throw new Error('not yet implemeted');
};

notFs.Stats.prototype.isDirectory = function() {
    //@TODO what does fs for not existing files
    if(false === this.notFsNode){
        return false;
    }
    return this.notFsNode.isDir();
};

notFs.Stats.prototype.isFile = function() {
    //@TODO what does fs for not existing files
    if(false === this.notFsNode){
        return false;
    }
    return this.notFsNode.isFile();
};

notFs.Stats.prototype.isBlockDevice = function() {
  throw new Error('not yet implemeted');
};

notFs.Stats.prototype.isCharacterDevice = function() {
  throw new Error('not yet implemeted');
};

notFs.Stats.prototype.isSymbolicLink = function() {
  throw new Error('not yet implemeted');
};

notFs.Stats.prototype.isFIFO = function() {
    throw new Error('not yet implemeted');
};

notFs.Stats.prototype.isSocket = function() {
  throw new Error('not yet implemeted');
};
