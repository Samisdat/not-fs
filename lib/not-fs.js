...
notFs.appendFile = function(file, data, options, callback){
    ...
    if(true === notFs.hasForce('appendFile')){
        callbackParam = notFs.doForce('appendFile');
    }
...
notFs.mkdir = function(path, mode, callback){
    ...
    if(true === notFs.hasForce('mkdir')){
        callbackParam = notFs.doForce('mkdir');
    }
...
notFs.readdir = function(path, callback){
    ...
    try{
        var files = notFs.readdirSync(path);
    }
    catch(e){
        error = e;
    }
...
notFs.rename = function(oldPath, newPath, callback){
    ...
    if(true === notFs.hasForce('rename')){
        callbackParam = notFs.doForce('rename');
    }
...
notFs.writeFile = function(file, data, options, callback){
    ...
    if(true === notFs.hasForce('writeFile')){
        callbackParam = notFs.doForce('writeFile');
    }
